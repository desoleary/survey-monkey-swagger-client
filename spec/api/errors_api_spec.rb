...
# Unit tests for SurveyMonkeySwaggerClient::ErrorsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorsApi' do
  before do
    # run before each test
    @instance = SurveyMonkeySwaggerClient::ErrorsApi.new
  end
  ...
  describe 'test an instance of ErrorsApi' do
    it 'should create an instance of ErrorsApi' do
      expect(@instance).to be_instance_of(SurveyMonkeySwaggerClient::ErrorsApi)
    end
  end
